...
**Service: Certificate of Registration as Promoter**
...
Document Title: BRD \- Certificate of Registration as Promoter

Owning Department: Estate/Property / Developer Registration Cell (Assumption \- confirm with PUDA/GMADA/Authority)

Primary Source of Truth: PUDA portal 'Certificate of Registration as Promoter' service details (https://www.puda.gov.in/service-details-estate-agent/29)

Application Disposal Time (SLS): To be confirmed
...
The 'Certificate of Registration as Promoter' service enables an applicant to submit an online request via the PUDA Citizen Services Portal/Mobile App. The system shall capture application details and required documents, route the request through role-based scrutiny/verification stages, enforce Service Level Standards (SLS), and on disposal generate a downloadable output (letter/certificate/order) along with notifications and audit trails.

Key service notes from input:

* Physical verification required (as indicated on the service details page).  
* Demand draft and bank guarantee requirements are specified in the document list; online payment integration is not indicated.
...
| Attribute | Value |
| :---- | :---- |
| Service Name | Certificate of Registration as Promoter |
| Service Category | Developer Services |
| Authorities | PUDA, GMADA, GLADA, BDA (as displayed on portal header) |
| Application Disposal Time (SLS) | Not specified on service details page; to be confirmed. |
| Workflow Roles | Workflow stages not published on service page; to be confirmed. |
| Document(s) Required | Proof of educational qualification (Not less than Matric); Proof of age (at least 18 years). Matric Certificate, Aadhar Card, PAN Card, Passport etc.; Proof of experience of at least 5 years as estate agent/ Property dealer (In form of affidavit); ... |
| Physical Verification | Required. Details to be confirmed. |
| Output | Promoter Registration Certificate (downloadable). |
...
* Applicant seeks Certificate of Registration as Promoter (developer service).

Preconditions (to be validated):

* Applicant meets eligibility conditions implied by checklist (education, age, experience).  
* Applicant can provide demand draft and bank guarantee as per checklist.  
* Firm/company/co-operative society documents are available where applicable.
...
* Applicant as Firm/Company/Co-operative society (as per 'Select Status of The Applicant')

## **4.2 Internal Users (Role-based)**

* Dealing Assistant/Clerk (Assumption)  
* Competent Authority (Assumption)
...
| 2 | System | Submitted application | Validate mandatory fields and required documents; create workflow task for first processing role; send acknowledgement | Task assigned; acknowledgement to applicant | Pending at Processing Officer | Immediate | Auto-validation rules (e.g., UPN/registry lookup) to be confirmed. |
| 3 | Dealing Assistant/Clerk (Assumption) | Application \+ uploaded documents | Initial scrutiny; verify completeness and basic correctness; record remarks; forward OR raise query OR reject (query/reject assumed) | Forwarded / Query raised / Rejected | Pending at Field Verification Officer (Assumption) OR Query Pending OR Rejected | 2 Days | Physical verification requirement and responsibility to be confirmed (if applicable). |
| 4 | Applicant | Query from processing role (if raised) | Provide clarifications/corrections; re-upload document(s) if required; resubmit | Resubmitted application | Resubmitted to Dealing Assistant/Clerk (Assumption) | TBD | Response time window and SLA pause/reset rules to be confirmed. |
| 5 | Field Verification Officer (Assumption) | Application package \+ previous stage remarks/verification records | Verification and review; record remarks; forward OR raise query OR reject (assumed) | Forwarded / Query raised / Rejected | Pending at Competent Authority (Assumption) | 2 Days | If physical verification is required, completion may be mandatory prior to approval (Assumption). |
| 6 | Competent Authority (Assumption) | Application package \+ previous stage remarks/verification records | Final review; confirm verification; approve or reject; record final remarks | Approved / Rejected | Approved OR Rejected | 1 Day | If physical verification is required, completion may be mandatory prior to approval (Assumption). |
...
| Submitted | Application successfully submitted; ARN generated. | Submit action completes | System assigns first task | Submitted \-\> Pending at Processing Officer |
| Pending at Processing Officer | Application is under initial scrutiny. | System assignment to role | Role forwards / raises query / rejects | \-\> Pending at Approving Officer OR \-\> Query Pending OR \-\> Rejected |
...
| Resubmitted | Applicant has responded to query and resubmitted. | Applicant resubmits | System reassigns to originating officer | Resubmitted \-\> Pending at Processing Officer |
| Pending at Approving Officer | Application under secondary/technical verification. | Forward from previous role | Role forwards / raises query / rejects / approves | \-\> Approved/Rejected OR \-\> Query Pending OR \-\> Pending at next role |
...
| :---- | :---- | :---- | :---- |
| 1 | Applicant Details | Select Status of Applicant (Individual/Firm/Company etc.); Salutation; Full Name; Father's Name; Gender; Marital Status; Date of Birth; UID/Aadhaar Number; Email Address; Mobile Number | Citizen-provided. Editable in Draft; locked after submit unless query. |
| 2 | Addresses | Permanent Address (Full Address, State, District, Pincode); Correspondence Address (Same as Permanent?; Full Address, State, District, Pincode) | Citizen-provided. Editable in Draft; locked after submit unless query. |
| 3 | Payment Instrument Details | Demand Draft details (No., Date, Bank, Amount); Bank Guarantee details (No., Date, Bank, Amount, validity) | Applicant provides; verification by Accounts/Finance (Assumption). Editable in Draft; locked after submit unless query. |
| 4 | Eligibility Declarations | Educational qualification; Age proof; Experience (\>=5 years) affidavit; Non-conviction affidavit; Income tax clearance details | Citizen-provided. Editable in Draft; locked after submit unless query. |
| 5 | Documents & Submit | Upload mandatory documents as per Section 10 (APR forms, affidavits, photos, firm documents, DD/BG copies) | Applicant uploads and submits. After submit, only resubmission possible via query. |
...
| DR-02 | System shall capture core application fields as per the published form (Applicant status, Personal Details, Addresses). | Must | All published core fields are present on the form and persisted with the application. |
...
| DR-04 | System shall capture and store service-specific details (Payment instrument details (DD/BG), eligibility declarations, firm/company details (where applicable)) as structured data. | Must | Service-specific fields are stored and visible to processing officers; exports include these fields where relevant. |
...
| :---- | :---- | :---- | :---- | :---- | :---- |
| DOC-01 | Proof of educational qualification (Not less than Matric) | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-02 | Proof of age (at least 18 years). Matric Certificate, Aadhar Card, PAN Card, Passport etc. | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-03 | Proof of experience of at least 5 years as estate agent/ Property dealer (In form of affidavit) | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-04 | Demand draft of Rs. 5000 \+ 18% GST in favour of Addl. Chief Administrator, GMADA payable at Mohali | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-05 | Bank Guarantee of Rs. 50,000 in favour of Addl. Chief Administrator, GMADA, Mohali | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-06 | Upto date Income tax clearance certificate from Income Tax department | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-07 | Proof of registration in case of Firm / Company/ Co-operative society | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-08 | Authorization letter from Firm/ Company / Co-operative society to act on their behalf | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-09 | Application form, APR-X(Attested by Oath commissioner/ Magistrate first class) | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-10 | Affidavit for Non-conviction by any court last five years | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-11 | Upload Recent Photograph | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-12 | Form APR XXI (Required in case of Renewal Only) | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |

# **11\. Functional Requirements (FR)**

| ID | Description | Priority | Acceptance Criteria |
| :---- | :---- | :---- | :---- |
| FR-01 | System shall allow users to select the Authority (PUDA/GMADA/GLADA/BDA) and initiate the 'Certificate of Registration as Promoter' service. | Must | User can initiate the service for a selected authority; service landing page shows key requirements and SLS. |
...
| FR-08 | System shall route applications through role-based workflow stages as per service configuration (starting with 'Dealing Assistant/Clerk (Assumption)'). | Must | After submission, the application appears in the first stage officer inbox; subsequent stage routing matches configured workflow. |
...
| FR-11 | System shall support service-specific verification needs: Offline instrument details (Demand Draft/Bank Guarantee) must be captured and verified before approval (Assumption). | Should | Verification outcome is captured as structured fields/remarks; approval can be configured to require verification completion. |
| FR-12 | System shall support fee/payment capture for the service where applicable. Offline instrument: Demand Draft of Rs. 5000 \+ 18% GST in favour of Addl. Chief Administrator (GMADA) payable at Mohali; Bank Guarantee of Rs. 50,000 (as per service details). | Should | If fee is configured: payment is captured (online transaction or offline instrument details) and receipt/reference is stored; failures are handled gracefully. |
...
| BR-02 | Applicant must meet eligibility: educational qualification not less than Matric; age at least 18 years; experience at least 5 years as estate agent/property dealer (as per document list). | Must | System enforces mandatory documents for eligibility (qualification, age proof, experience affidavit). |
| BR-03 | Demand draft of Rs. 5000 \+ 18% GST and bank guarantee of Rs. 50,000 shall be required as per service checklist (offline instruments). | Must | System captures DD/BG details and requires upload of supporting documents; application cannot be approved until verified (configurable). |
...
| IR-04 | System shall support capturing offline payment instrument details (Demand Draft/Bank Guarantee) and, where required, integrate with internal finance verification workflow (manual/optional integration). | Should | Finance user can verify instrument details; verification status is stored and audit-logged. |
| IR-05 | System should support validation of PAN format and, where available, PAN verification integration. | Could | Invalid PAN formats are blocked; verification status can be recorded if integrated. |
| IR-06 | System should integrate with Authority master data (authorities, districts, etc.) for drop-downs and validations. | Must | Master data values are centrally managed and available in the form. |
...
| :---- | :---- | :---- | :---- |
| Application Submitted | Applicant | SMS/Email/In-app | Acknowledgement with ARN for Certificate of Registration as Promoter. |
...
PUDA: Your 'Certificate of Registration as Promoter' application has been submitted. ARN: {ARN}. Track status on portal.

SMS \- Query Raised (Template)

PUDA: Query raised for ARN {ARN} in 'Certificate of Registration as Promoter'. Please respond by {DUE\_DATE} on portal.

SMS \- Application Approved (Template)

PUDA: Your 'Certificate of Registration as Promoter' application ARN {ARN} is approved. Download certificate/letter from portal.
...
Overall and stage-wise SLS are not published on the service details page; to be confirmed by business.
...
| :---- | :---- | :---- | :---- | :---- | :---- |
| TC-PROM-01 | Happy path approval without query | Applicant logged in; required data and documents available. | Fill form \-\> upload docs \-\> submit \-\> internal processing \-\> approve \-\> download output | Application is approved within SLS; output is generated and downloadable. | Happy |
| TC-PROM-02 | Mandatory field validation | Applicant logged in. | Attempt submission with missing mandatory fields | System blocks submission and highlights missing fields. | Negative |
| TC-PROM-03 | Mandatory document missing | Applicant logged in. | Attempt submission without uploading a mandatory document | System blocks submission and shows required document checklist. | Negative |
| TC-PROM-04 | Query raised and resubmission | Application submitted successfully. | Officer raises query \-\> applicant receives notification \-\> applicant edits allowed fields/re-uploads docs \-\> resubmits | Application returns to the originating officer; query is marked resolved on further processing. | Rework |
| TC-PROM-05 | Rejection by competent authority | Application submitted successfully. | Application processed \-\> approver rejects with reason code and remarks | Status becomes Rejected; rejection order is generated; applicant is notified. | Negative |
| TC-PROM-06 | SLA breach at an internal stage | Application pending at a stage beyond due date. | Let task exceed configured due date | Task flagged overdue; escalation notification sent; breach recorded in report. | SLA |
| TC-PROM-07 | Document mismatch detected during scrutiny | Application submitted. | Officer marks document mismatch and raises query or rejects | System captures mismatch reason; applicant is notified; workflow follows decision. | Negative |
| TC-PROM-08 | Physical verification fail | Physical verification required for service. | Verifier records failed verification \-\> approver rejects (or raises query) | Decision recorded with verification remarks; applicant notified; output generated. | Negative |
| TC-PROM-09 | No-fee service does not prompt for payment | Applicant initiates service. | Proceed to submission flow | No payment step is shown by default; submission succeeds based on data/docs. | Functional |
| TC-PROM-10 | Duplicate application detection | An existing active application exists for same key identifiers. | Submit a second application with same identifiers | System warns or blocks duplicate submission as per configured rule. | Negative |
| TC-PROM-11 | Role-based access control for internal staff | Two staff users with different roles. | Attempt to access applications outside role/jurisdiction | Access denied or masked data; attempt is logged. | Security |
| TC-PROM-12 | Output download and verification | Application disposed. | Applicant downloads output; verify QR/digital signature (if enabled) | Output is readable and verifiable; download logged in audit. | Functional |
...
| :---- | :---- | :---- | :---- |
| 1 | Fill application form, upload documents and submit application | FR-01, FR-02, FR-03, FR-04, FR-05, DR-01, DR-02, DR-03 | TC-PROM-01, TC-PROM-02, TC-PROM-03 |
| 2 | Validate mandatory fields and required documents | FR-06, FR-08, FR-14, FR-15, DR-01, DR-06, NFR-09 | TC-PROM-01, TC-PROM-12 |
| 3 | Initial scrutiny | FR-08, FR-09, FR-10, FR-13, BR-06, DR-06, DR-08, FR-11, BR-05 | TC-PROM-04, TC-PROM-05, TC-PROM-06, TC-PROM-08 |
| 4 | Provide clarifications/corrections | FR-01, FR-02, FR-03, FR-04, FR-05, DR-01, DR-02, DR-03 | TC-PROM-01, TC-PROM-02, TC-PROM-03 |
| 5 | Verification and review | FR-08, FR-09, FR-10, FR-13, BR-06, DR-06, DR-08, FR-11, BR-05 | TC-PROM-04, TC-PROM-05, TC-PROM-06, TC-PROM-08 |
| 6 | Final review | FR-08, FR-09, FR-10, FR-13, BR-06, DR-06, DR-08, FR-11, BR-05 | TC-PROM-04, TC-PROM-05, TC-PROM-06, TC-PROM-08 |
| 7 | Generate certificate/letter (approval or rejection order), close application, and notify applicant | FR-06, FR-08, FR-14, FR-15, DR-01, DR-06, NFR-09 | TC-PROM-01, TC-PROM-12 |
| 8 | Download output and view final status | FR-01, FR-02, FR-03, FR-04, FR-05, DR-01, DR-02, DR-03 | TC-PROM-01, TC-PROM-02, TC-PROM-03 |

## **19.2 Dependencies**

| Dependency | Description | Impact if Not Available |
| :---- | :---- | :---- |
| Applicant/Entity Master Data | Master data for applicant status types, districts, etc. | Form capture becomes inconsistent; manual workarounds. |
...
| :---- | :---- | :---- | :---- |
| R-01 | Incomplete/incorrect applicant/entity details may lead to rejection and rework. | Medium | Form validations; clear instructions; query workflow. |
...
* Workflow roles/levels and SLS are not shown on the service details page. Please confirm processing stages and timelines (e.g., Clerk \-\> Superintendent \-\> Competent Authority).  
* Is this service applicable across PUDA/GMADA/GLADA/BDA, or only for GMADA? (DD favouring Addl. Chief Administrator, GMADA is mentioned.)  
* How should offline instruments (DD and Bank Guarantee) be validated and tracked (verification by Accounts/Finance)?  
* Is renewal handled via the same service using Form APR XXI? If yes, what additional rules apply (e.g., validity, renewal fee)?  
...
* Service details page (input): https://www.puda.gov.in/service-details-estate-agent/29  
