...
**Service: Issue of Completion Certificate/ Occupation Certificate Above 1000 Sq Yards (Private Property)**
...
Document Title: BRD \- Issue of Completion Certificate/ Occupation Certificate Above 1000 Sq Yards (Privat Property)

Owning Department: Engineering / Building Control Wing (Assumption)

Primary Source of Truth: PUDA service details page (input) accessed on 02 Feb 2026: https://www.puda.gov.in/service-details-private-properties/1788
...
| Attribute | Value |
| :---- | :---- |
| Service Name | Issue of Completion Certificate/ Occupation Certificate Above 1000 Sq Yards (Privat Property) |
...
| Source URL | https://www.puda.gov.in/service-details-private-properties/1788 |
...
PUDA: Your 'Issue of Completion Certificate/ Occupation Certificate Above 1000 Sq Yards (Privat Property)' application has been submitted. ARN: {ARN}. Track status on portal.

SMS \- Query Raised (Template)

PUDA: Query raised for ARN {ARN} in 'Issue of Completion Certificate/ Occupation Certificate Above 1000 Sq Yards (Privat Property)'. Please respond by {DUE\_DATE} on portal.

SMS \- Application Approved (Template)

PUDA: Your 'Issue of Completion Certificate/ Occupation Certificate Above 1000 Sq Yards (Privat Property)' application ARN {ARN} is approved. Download certificate/letter from portal.

SMS \- Application Rejected (Template)

PUDA: Your 'Issue of Completion Certificate/ Occupation Certificate Above 1000 Sq Yards (Privat Property)' application ARN {ARN} is rejected. Reason: {SHORT\_REASON}. Details on portal.
...
* Service details page (input): https://www.puda.gov.in/service-details-private-properties/1788  
