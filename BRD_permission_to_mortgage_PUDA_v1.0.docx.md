...
**Service: Permission to Mortgage**
...
**Document Title:** BRD \- Permission to Mortgage

**Owning Department:** Estate/Property Branch (Assumption \- confirm with PUDA)

**Primary Source of Truth:** PUDA portal service details (https://www.puda.gov.in/service-details/34), accessed 03 Feb 2026\.

**Application Disposal Time (SLS):** 7 Days (as published on service details page).
...
The 'Permission to Mortgage' service enables an applicant to submit an online request via the PUDA citizen portal for permission to mortgage (noc/permission letter) for the specified property; bank-facing output. The application is processed through a role-based workflow (Clerk (2 days) \-\> Senior Assistant (3 days) \-\> Superintendent (2 days) \-\> Disposal). The published Service Level Standard (SLS) is 7 days. The service details page indicates that physical verification is required.
...
| Attribute | Value |
| :---- | :---- |
| Service Name | Permission to Mortgage |
...
| Workflow Roles | Clerk (2 days) \-\> Senior Assistant (3 days) \-\> Superintendent (2 days) \-\> Disposal |
| Document(s) Required | Consent of bank from which loan is being raised in the prescribed format; Self attested Proof of Ownership |
| Physical Verification | Required (as per portal note) |
| Output | Permission to Mortgage (NOC/permission letter) for the specified property; bank-facing output. |
...
Applicant seeks permission to mortgage a PUDA/ADA property to a bank/financial institution for raising a loan.
...
* Bank consent in prescribed format is available.
...
* Bank/Financial institution (as external party; no portal login assumed)
...
The published processing sequence is: Submit Application \-\> Clerk (2 days) \-\> Senior Assistant (3 days) \-\> Superintendent (2 days) \-\> Disposal.
...
| 5 | Senior Assistant | Application package \+ remarks | Review application and documents; record remarks; forward to next role OR raise query OR reject | Forwarded / Query raised / Rejected | Pending at Superintendent OR Query Pending OR Rejected | 3 Days | Physical verification/original document checks may be mandatory before approval (confirm). |
...
| 7 | Superintendent | Application package \+ remarks | Review application and documents; record remarks; approve/reject | Approved / Rejected | Approved OR Rejected | 2 Days | Physical verification/original document checks may be mandatory before approval (confirm). |
...
| Bank/Loan | Bank name, consent reference, loan purpose/amount (TBD). |
...
| 3 | Mortgage Details | Bank name; Branch; Loan purpose; Loan amount (TBD); Consent reference | Citizen enters; bank consent document uploaded. |
...
| :---- | :---- | :---- | :---- | :---- | :---- |
| DOC-01 | Consent of bank from which loan is being raised in the prescribed format | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-02 | Self attested Proof of Ownership | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
...
Published application disposal time (SLS): 7 Days (as per service details page).
...
| Superintendent | 2 Days | Stage actions: forward/query/reject/approve as applicable. |
...
| Step 7 | Superintendent \- Review application and documents; record... | FR-01; FR-03; DR-01; NFR-03 | TC-01; TC-02; TC-03 |
...
PUDA Service Details Page: https://www.puda.gov.in/service-details/34 (captured in input PDF).
