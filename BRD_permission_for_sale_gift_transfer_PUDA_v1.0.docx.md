...
**Service: Permission for Sale/Gift/Transfer**
...
**Document Title:** BRD \- Permission for Sale/Gift/Transfer

**Owning Department:** Estate/Property Branch (Assumption \- confirm with PUDA)

**Primary Source of Truth:** PUDA portal service details (https://www.puda.gov.in/service-details/20), accessed 03 Feb 2026\.
...
The 'Permission for Sale/Gift/Transfer' service enables an applicant to submit an online request via the PUDA citizen portal for permission/noc for sale/gift/transfer (pre-transfer permission) for the specified property. The application is processed through a role-based workflow (Clerk (3 days) \-\> Senior Assistant (4 days) \-\> Superintendent (3 days) \-\> Disposal). The published Service Level Standard (SLS) is 10 days. The service includes a processing fee payable at submission, as per the published fee schedule. The service details page indicates that physical verification is required.
...
| Attribute | Value |
| :---- | :---- |
| Service Name | Permission for Sale/Gift/Transfer |
...
| Workflow Roles | Clerk (3 days) \-\> Senior Assistant (4 days) \-\> Superintendent (3 days) \-\> Disposal |
| Document(s) Required | Affidavit from the all Sellers that the property is free from all sorts of encumbrances or litigation in any court of law, liens, mortgage etc.; Liability affidavit of All Purchasers / Doners / Transferees; Certified copy of GPA and Sub Attorney if applicable; ... |
| Physical Verification | Required (as per portal note) |
| Output | Permission/NOC for sale/gift/transfer (pre-transfer permission) for the specified property. |
...
Applicant seeks prior permission/NOC from PUDA for sale/gift/transfer of a property before executing the deed.
...
* Property is free from encumbrances/litigation as declared via affidavit.
...
* Superintendent \- processes the application at assigned stage with role-specific permissions.  
...
The published processing sequence is: Submit Application \-\> Clerk (3 days) \-\> Senior Assistant (4 days) \-\> Superintendent (3 days) \-\> Disposal.

## **9.1 Workflow Step Table**

| Step No | Actor | Inputs | Action | Output/Decision | Next State | SLS | Exceptions / Notes |
| :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| 1 | Applicant | Property & applicant details; required documents | Fill application form; upload documents; accept declaration; submit application | Application submitted; ARN generated (system) | Payment Pending | Immediate | If service is not yet enabled online, submission should be disabled with message (for portal). |
| 2 | System/Applicant | Fee payable | Initiate payment; redirect to payment gateway; capture success/failure | Payment success or failure recorded | Submitted (on success) / Payment Failed | Immediate | Payment failure handling and retry as per policy (TBD). |
| 3 | System | Submitted application | Validate mandatory fields and required document presence; create workflow task for first role; send acknowledgement | Task assigned to Clerk; acknowledgement to applicant | Pending at Clerk | Immediate | Auto-validation rules (e.g., UPN lookup) \- to be confirmed. |
| 4 | Clerk | Application package \+ remarks | Review application and documents; record remarks; if physical verification is required, initiate/record verification (assumption); forward to next role OR raise query OR reject | Forwarded / Query raised / Rejected | Pending at Senior Assistant OR Query Pending OR Rejected | 3 Days | Physical verification/original document checks may be mandatory before approval (confirm). |
| 5 | Applicant (if query raised) | Query/deficiency memo from authority | Provide clarification; correct fields; re-upload document(s) if required; resubmit | Resubmitted application | Resubmitted to Clerk | TBD | Query response time window and SLA pause/reset rules \- Open Question. |
| 6 | Senior Assistant | Application package \+ remarks | Review application and documents; record remarks; forward to next role OR raise query OR reject | Forwarded / Query raised / Rejected | Pending at Superintendent OR Query Pending OR Rejected | 4 Days | Physical verification/original document checks may be mandatory before approval (confirm). |
| 7 | Applicant (if query raised) | Query/deficiency memo from authority | Provide clarification; correct fields; re-upload document(s) if required; resubmit | Resubmitted application | Resubmitted to Senior Assistant | TBD | Query response time window and SLA pause/reset rules \- Open Question. |
| 8 | Superintendent | Application package \+ remarks | Review application and documents; record remarks; approve/reject | Approved / Rejected | Approved OR Rejected | 3 Days | Physical verification/original document checks may be mandatory before approval (confirm). |
| 9 | System | Final decision | Generate digitally signed/approved output (order/permission/certificate as applicable); update records; close application; notify applicant | Output generated; application closed | Closed | Same day | Integration with property master, document signing and dispatch \- to be confirmed. |
| 10 | Applicant | Disposed application | Download/print output; view final status and history | Output downloaded | Closed | NA | If physical originals submission is required, it must be communicated to applicant (Open Question). |
...
| Submitted | Application submitted; system validations and assignment pending/complete. | Submit | Auto-assign | Submitted \-\> Pending at Clerk; Submitted \-\> Payment Pending (if configured) |
| Payment Pending | Payment is pending or failed (fee applicable). | Payment required | Payment success/cancel | Payment Pending \-\> Pending at Clerk; Payment Pending \-\> Cancelled |
| Payment Failed | Payment attempt failed; applicant must retry within configured window. | Gateway failure | Retry/timeout | Payment Failed \-\> Payment Pending; Payment Failed \-\> Cancelled (timeout \- TBD) |
...
| Pending at Superintendent | Application under processing by Superintendent. | Auto-assign/forward | Forward / Query / Reject / Approve | Approved OR Rejected |
...
| Payment | Fee head, amount, GST breakup (if applicable), transaction ID, status, gateway response, receipt number. |
...
| 3 | Transfer Details | Seller details (name/ID); Purchaser/Transferee details (name, father name, address, mobile, email); Share to be transferred (%) (if applicable) | Citizen enters; supports multiple purchasers/transferees as per form. |
...
* Payment transaction reference must be mandatory for successful submission when fee is applicable.
...
| :---- | :---- | :---- | :---- | :---- | :---- |
| DOC-01 | Affidavit from the all Sellers that the property is free from all sorts of encumbrances or litigation in any court of law, liens, mortgage etc. | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-02 | Liability affidavit of All Purchasers / Doners / Transferees | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-03 | Certified copy of GPA and Sub Attorney if applicable | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-04 | Certified Copy of conveyance deed (if applicable) | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-05 | Clearance against loan / mortgage (if applicable) | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-06 | Self attested copy of sanction of Sewerage Connection / Occupation Certificate , if obtained | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-07 | Photo identity proof of All Purchasers. | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-08 | Photo Identity Proof of All Sellers | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-09 | including GST (Annu ally increases 10% from 1,April) | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
...
| FR-06 | The system shall calculate the applicable processing fee and collect payment via configured payment modes. | Must | Fee is computed as per Section 13; payment success updates application to Submitted; failure keeps it in Payment Pending/Failed. |
...
| BR-03 | Processing fee shall be charged as per the published fee schedule and GST rules (as applicable). | Must | System computes fee as per Section 13 and prevents submission without successful payment. |
...
| BR-06 | Processing fee for Permission for Sale/Gift/Transfer shall be INR 10,300 (Residential plot) and INR 20,600 (Commercial plot), including GST, with annual increase of 10% from 1 April (as per service details). | Must | Fee amounts and annual escalation logic are configured and verified through test cases. |
...
| IR-04 | Integration with Payment Gateway for online fee collection and receipt generation. | Must | Payment status callbacks update the application; receipts are generated and stored. |
...
| N-01A | Payment success/failure | Applicant | SMS/Email/In-app | Payment status, receipt link or retry instruction |
...
Published application disposal time (SLS): 10 Days (as per service details page).

| Stage/Role | Published Stage Time | Notes |
| :---- | :---- | :---- |
| Clerk | 3 Days | Stage actions: forward/query/reject/approve as applicable. |
| Senior Assistant | 4 Days | Stage actions: forward/query/reject/approve as applicable. |
| Superintendent | 3 Days | Stage actions: forward/query/reject/approve as applicable. |
...
| TC-07 | Payment failure and retry | Payment gateway returns failure. | Initiate payment \-\> Failure \-\> Retry \-\> Success \-\> Submit. | Application remains in Payment Failed/Pending until success; receipt generated only once. | Payment |
...
| Step 2 | System/Applicant \- Initiate payment; redirect to payment ga... | FR-01; FR-03; DR-01; NFR-03 | TC-01; TC-02; TC-03 |
| Step 3 | System \- Validate mandatory fields and required d... | FR-01; FR-03; DR-01; NFR-03 | TC-01; TC-02; TC-03 |
| Step 4 | Clerk \- Review application and documents; record... | FR-01; FR-03; DR-01; NFR-03 | TC-01; TC-02; TC-03 |
| Step 5 | Applicant (if query raised) \- Provide clarification; correct fields; r... | FR-01; FR-03; DR-01; NFR-03 | TC-01; TC-02; TC-03 |
| Step 6 | Senior Assistant \- Review application and documents; record... | FR-01; FR-03; DR-01; NFR-03 | TC-01; TC-02; TC-03 |
| Step 7 | Applicant (if query raised) \- Provide clarification; correct fields; r... | FR-01; FR-03; DR-01; NFR-03 | TC-01; TC-02; TC-03 |
| Step 8 | Superintendent \- Review application and documents; record... | FR-01; FR-03; DR-01; NFR-03 | TC-01; TC-02; TC-03 |
| Step 9 | System \- Output generation/closure | FR-12; IR-05; NFR-09; REP-01 | TC-01; TC-12 |
...
* Confirm whether fee schedule changes require admin configuration and how annual escalation is applied (date effective and rounding rules).

## **19.6 References**

PUDA Service Details Page: https://www.puda.gov.in/service-details/20 (captured in input PDF).
