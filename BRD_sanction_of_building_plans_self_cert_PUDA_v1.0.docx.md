...
**Service: Sanction of Building Plans \- Under Self certification Scheme**
...
Document Title: BRD \- Sanction of Building Plans \- Under Self certification Scheme

Owning Department: Town Planning / Building Plan Branch (Assumption)

Primary Source of Truth: PUDA service details page (input) accessed on 02 Feb 2026: https://www.puda.gov.in/service-details/1791
...
| Attribute | Value |
| :---- | :---- |
| Service Name | Sanction of Building Plans \- Under Self certification Scheme |
...
| Source URL | https://www.puda.gov.in/service-details/1791 |
...
| 5 | Field Inspection | Inspection assignment; site details | Conduct physical verification/site inspection; upload report and photos; record findings | Inspection report submitted | Inspection Completed | Within overall SLS (configure) | If site not accessible, record attempt and reschedule (Open Question). |
| 6 | SDO | Application data; documents | Scrutinize application as per role responsibilities; verify documents; record remarks. | Approve to next stage / Raise query / Recommend rejection | Under Review \- SDO | 3 day(s) | Query can be raised for missing/invalid documents; applicant resubmits. |
...
| DOC-05 | Proof of Ownership (Allotment Letter / Change of Ownership) | Citizen/Applicant | Yes | Submission | Verify legibility, relevance to property, and authenticity as per internal SOP. |
| DOC-06 | Zoning plan | Citizen/Applicant | Yes | Submission | Verify legibility, relevance to property, and authenticity as per internal SOP. |
| DOC-07 | Undertaking / Affidavit by Applicant | Citizen/Applicant | Yes | Submission | Verify legibility, relevance to property, and authenticity as per internal SOP. |
...
| DOC-09 | Undertaking for Public Health Component | Citizen/Applicant | Yes | Submission | Verify legibility, relevance to property, and authenticity as per internal SOP. |
| DOC-10 | Any other supporting document | Citizen/Applicant | Yes | Submission | Verify legibility, relevance to property, and authenticity as per internal SOP. |
| DOC-11 | Sanction of Building Plans PDF file | Citizen/Applicant | Yes | Submission | Verify legibility, relevance to property, and authenticity as per internal SOP. |
| DOC-12 | Mining Charges Fee Receipt. (Mining Charges to be deposited at Mining Department) (if applicable) | Citizen/Applicant | Yes | Submission | Verify legibility, relevance to property, and authenticity as per internal SOP. |
...
| FR-18 | System shall support building plan files in DWG and PDF formats and maintain versioning across resubmissions. | Must | DWG and PDF are accepted; versions are tracked and accessible to authorised roles. |
| FR-19 | System shall support capturing mining charges fee receipt as an optional document when applicable and allow verifier to mark it verified/unverified. | Should | When uploaded, receipt is displayed and verifiable; if marked required by business rule, submission validation enforces it. |
| FR-20 | System shall provide configurable SLA timers and escalation alerts for each workflow stage. | Should | Stage due dates are computed; breaches are highlighted and alerts are triggered. |
...
PUDA: Your 'Sanction of Building Plans \- Under Self certification Scheme' application has been submitted. ARN: {ARN}. Track status on portal.

SMS \- Query Raised (Template)

PUDA: Query raised for ARN {ARN} in 'Sanction of Building Plans \- Under Self certification Scheme'. Please respond by {DUE\_DATE} on portal.

SMS \- Application Approved (Template)

PUDA: Your 'Sanction of Building Plans \- Under Self certification Scheme' application ARN {ARN} is approved. Download certificate/letter from portal.

SMS \- Application Rejected (Template)

PUDA: Your 'Sanction of Building Plans \- Under Self certification Scheme' application ARN {ARN} is rejected. Reason: {SHORT\_REASON}. Details on portal.
...
* Service details page (input): https://www.puda.gov.in/service-details/1791  
