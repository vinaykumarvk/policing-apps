...
**Service: Permitting Professional Consultancy Services**
...
**Document Title:** BRD \- Permitting Professional Consultancy Services

**Owning Department:** Town Planning / Building Branch (Assumption \- confirm with PUDA)

**Primary Source of Truth:** PUDA portal service details (https://www.puda.gov.in/service-details/33), accessed 03 Feb 2026\.
...
The 'Permitting Professional Consultancy Services' service enables an applicant to submit an online request via the PUDA citizen portal for permission letter to run professional consultancy services at the specified premises. The application is processed through a role-based workflow (Clerk (3 days) \-\> Senior Assistant (4 days) \-\> AEO (3 days) \-\> Disposal). The published Service Level Standard (SLS) is 10 days. The service details page indicates that physical verification is required.
...
| Attribute | Value |
| :---- | :---- |
| Service Name | Permitting Professional Consultancy Services |
...
| Workflow Roles | Clerk (3 days) \-\> Senior Assistant (4 days) \-\> AEO (3 days) \-\> Disposal |
| Document(s) Required | Copy of approved building plan on which area to be used for consultancy is duly marked; Affidavit; Building Plan; ... |
| Physical Verification | Required (as per portal note) |
| Output | Permission letter to run professional consultancy services at the specified premises. |
...
Applicant seeks permission to run professional consultancy services from a property/premises under PUDA/ADA jurisdiction.
...
The published processing sequence is: Submit Application \-\> Clerk (3 days) \-\> Senior Assistant (4 days) \-\> AEO (3 days) \-\> Disposal.
...
| 7 | AEO | Application package \+ remarks | Review application and documents; record remarks; approve/reject | Approved / Rejected | Approved OR Rejected | 3 Days | Physical verification/original document checks may be mandatory before approval (confirm). |
...
| Pending at AEO | Application under processing by AEO. | Auto-assign/forward | Forward / Query / Reject / Approve | Approved OR Rejected |
...
| Consultancy Details | Consultant PAN, qualification, consultancy type, marked area reference. |
...
| 3 | Consultancy Details | Authority selection; PAN of Consultant; Qualification details; Area to be used (TBD); Consultancy type (TBD) | Citizen enters; some values validated (PAN format). |
...
| :---- | :---- | :---- | :---- | :---- | :---- |
| DOC-01 | Copy of approved building plan on which area to be used for consultancy is duly marked | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-02 | Affidavit | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-03 | Building Plan | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-04 | Certificate of Qualification | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-05 | Receipt of Fee (Copy) | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
...
| AEO | 3 Days | Stage actions: forward/query/reject/approve as applicable. |
...
PUDA Service Details Page: https://www.puda.gov.in/service-details/33 (captured in input PDF).
