...
Document Title: BRD \- Demarcation of Plot

Owning Department: Engineering / Land Survey Wing (Assumption)

Primary Source of Truth: PUDA service details page (input) accessed on 02 Feb 2026: https://www.puda.gov.in/service-details/952

Application Disposal Time (SLS): 5 Day(s) (as published on service details page).
...
The 'Demarcation of Plot' service enables citizens to apply online through the PUDA portal/mobile app, upload required documents, and obtain Demarcation Report / Certificate after role-based scrutiny and approvals. The workflow supports tracking, queries/rework, and issuance of the final output.
...
| Attribute | Value |
| :---- | :---- |
| Service Name | Demarcation of Plot |
...
| Output | Demarcation Report / Certificate |
| Physical Verification | Yes (as indicated on service page) |
| Fees/Payments | Not specified in input (Open Question). |
| Published Disposal Time (SLS) | 5 Day(s) |
| Source URL | https://www.puda.gov.in/service-details/952 |
...
* Application is approved and Demarcation Report / Certificate is issued to applicant, OR application is rejected with recorded reason.  
...
* Generation and delivery of Demarcation Report / Certificate via portal/mobile download.  
...
* Digitally generated Demarcation Report / Certificate published to applicant dashboard.
...
| 5 | System | Final approval decision | Generate Demarcation Report / Certificate with unique number; apply digital signature (if enabled); store and publish to applicant dashboard | Demarcation Report / Certificate issued / Application closed | Approved \- Issued / Rejected | Same day | If rejected, reason is communicated and application is closed. |
...
| :---- | :---- | :---- | :---- | :---- | :---- |
| DOC-01 | Photocopy of the forwarding letter regarding sanction of building plan by empaneled architect Or issued by Estate officer. | Citizen/Applicant | Yes | Submission | Verify legibility, relevance to property, and authenticity as per internal SOP. |
| DOC-02 | Any other supporting document | Citizen/Applicant | Yes | Submission | Verify legibility, relevance to property, and authenticity as per internal SOP. |
...
| BR-06 | Forwarding letter regarding sanction of building plan is mandatory for initiating demarcation (as per required documents). | Must | Rule is enforced via validations/workflow; evidence is visible in case history/audit. |
...
PUDA: Your 'Demarcation of Plot' application has been submitted. ARN: {ARN}. Track status on portal.

SMS \- Query Raised (Template)

PUDA: Query raised for ARN {ARN} in 'Demarcation of Plot'. Please respond by {DUE\_DATE} on portal.

SMS \- Application Approved (Template)

PUDA: Your 'Demarcation of Plot' application ARN {ARN} is approved. Download certificate/letter from portal.

SMS \- Application Rejected (Template)

PUDA: Your 'Demarcation of Plot' application ARN {ARN} is rejected. Reason: {SHORT\_REASON}. Details on portal.
...
As per the service details page, overall application disposal time is 5 day(s) with stage-wise allocation:
...
* Is there any demarcation fee or scheduling window? Is GIS/coordinates output required?

## **19.6 References**

* Service details page (input): https://www.puda.gov.in/service-details/952  
