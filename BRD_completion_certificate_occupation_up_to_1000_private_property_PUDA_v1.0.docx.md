...
**Service: Issue of Completion Certificate/ Occupation Certificate up to 1000 Sq Yards (Private Property)**
...
Document Title: BRD \- Issue of Completion Certificate/ Occupation Certificate up to 1000 Sq Yards (Private Property)

Owning Department: Engineering / Building Control Wing (Assumption)

Primary Source of Truth: PUDA service details page (input) accessed on 02 Feb 2026: https://www.puda.gov.in/service-details-private-properties/1626
...
| Attribute | Value |
| :---- | :---- |
| Service Name | Issue of Completion Certificate/ Occupation Certificate up to 1000 Sq Yards (Private Property) |
...
| Source URL | https://www.puda.gov.in/service-details-private-properties/1626 |
...
| Junior Engineer | Site/technical verification and inspection report (if required). | View assigned applications; verify docs; record remarks; forward/query/reject per permissions. | 3 day(s) |
...
| 3 | Junior Engineer | Application data; documents | Scrutinize application as per role responsibilities; verify documents; record remarks. | Approve to next stage / Raise query / Recommend rejection | Under Review \- Junior Engineer | 3 day(s) | Query can be raised for missing/invalid documents; applicant resubmits. |
...
| :---- | :---- | :---- | :---- | :---- | :---- |
| DOC-01 | Structure stability certificate | Citizen/Applicant | Yes | Submission | Verify legibility, relevance to property, and authenticity as per internal SOP. |
| DOC-02 | Photographs of the completed building, to be pasted on the blank pages and duly attested by empanelled Architects | Citizen/Applicant | Yes | Submission | Verify legibility, relevance to property, and authenticity as per internal SOP. |
| DOC-03 | Notice of completion | Citizen/Applicant | Yes | Submission | Verify legibility, relevance to property, and authenticity as per internal SOP. |
| DOC-04 | Certificate of completion by empanelled Architect, of Authority as per list of empanelled Architects | Citizen/Applicant | Yes | Submission | Verify legibility, relevance to property, and authenticity as per internal SOP. |
| DOC-05 | Any other supporting document | Citizen/Applicant | Yes | Submission | Verify legibility, relevance to property, and authenticity as per internal SOP. |
| DOC-06 | Undertaking by owner with Photograph | Citizen/Applicant | Yes | Submission | Verify legibility, relevance to property, and authenticity as per internal SOP. |
...
PUDA: Your 'Issue of Completion Certificate/ Occupation Certificate up to 1000 Sq Yards (Private Property)' application has been submitted. ARN: {ARN}. Track status on portal.

SMS \- Query Raised (Template)

PUDA: Query raised for ARN {ARN} in 'Issue of Completion Certificate/ Occupation Certificate up to 1000 Sq Yards (Private Property)'. Please respond by {DUE\_DATE} on portal.

SMS \- Application Approved (Template)

PUDA: Your 'Issue of Completion Certificate/ Occupation Certificate up to 1000 Sq Yards (Private Property)' application ARN {ARN} is approved. Download certificate/letter from portal.

SMS \- Application Rejected (Template)

PUDA: Your 'Issue of Completion Certificate/ Occupation Certificate up to 1000 Sq Yards (Private Property)' application ARN {ARN} is rejected. Reason: {SHORT\_REASON}. Details on portal.
...
* Service details page (input): https://www.puda.gov.in/service-details-private-properties/1626  
