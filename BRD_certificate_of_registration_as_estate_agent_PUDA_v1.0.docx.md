...
**Service: Certificate of Registration as Estate Agent**
...
Document Title: BRD \- Certificate of Registration as Estate Agent

Owning Department: Estate/Property / Estate Agent Registration Cell (Assumption \- confirm with PUDA/GMADA/Authority)

Primary Source of Truth: PUDA portal 'Certificate of Registration as Estate Agent' service details (https://www.puda.gov.in/service-details-estate-agent/28)
...
The 'Certificate of Registration as Estate Agent' service enables an applicant to submit an online request via the PUDA Citizen Services Portal/Mobile App. The system shall capture application details and required documents, route the request through role-based scrutiny/verification stages, enforce Service Level Standards (SLS), and on disposal generate a downloadable output (letter/certificate/order) along with notifications and audit trails.
...
| Attribute | Value |
| :---- | :---- |
| Service Name | Certificate of Registration as Estate Agent |
...
| Document(s) Required | Application form- APR-XI (Attested by Oath commissioner/ Magistrate first class); Proof of educational qualification (Not less than Matric); Proof of age (at least 18 years) Addhar card, PAN Card, Passport, Matriculation certificate etc.; ... |
| Physical Verification | Required. Details to be confirmed. |
| Output | Estate Agent Registration Certificate (downloadable). |
...
* Applicant seeks Certificate of Registration as Estate Agent.
...
* Shop/office proof (rent agreement/property) and affidavits are available.
...
| 4 | Eligibility & Business Details | Educational qualification; Age proof; PAN number; Experience certificate (5 years); Shop/office rent agreement/property proof; Affidavit: not employed in Govt/Semi-Govt and non-conviction | Citizen-provided. Editable in Draft; locked after submit unless query. |
| 5 | Documents & Submit | Upload mandatory documents as per Section 10 (APR forms, affidavits, photos, office proof, DD/BG copies) | Applicant uploads and submits. After submit, only resubmission possible via query. |
...
| :---- | :---- | :---- | :---- | :---- | :---- |
| DOC-01 | Application form- APR-XI (Attested by Oath commissioner/ Magistrate first class) | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-02 | Proof of educational qualification (Not less than Matric) | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-03 | Proof of age (at least 18 years) Addhar card, PAN Card, Passport, Matriculation certificate etc. | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-04 | Certified copy of rent agreement/ Property of shop where the work of property will be done | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-05 | Demand draft of Rs. 2500/- \+ 18% GST in favor of Addl. Chief Administrator, GMADA payable at Mohali | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-06 | Bank Guarantee of Rs. 10,000 in favour of Addl. Chief Administrator, GMADA, Mohali | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-07 | Income Tax department PAN number | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-08 | Five years experience certificate from GMADA approved agent/ promoter | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-09 | Affidavit from applicant regarding not to do the job in any Govt./ Semi-govt. department and Non-conviction by any court in last five years | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-10 | Form APR-XXII (In case of Renewal only) | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-11 | Copy of Resident proof ( Aadhar card, Voter card, Ration card, Passport etc.) | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-12 | Upload Recent Photograph | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |

# **11\. Functional Requirements (FR)**

| ID | Description | Priority | Acceptance Criteria |
| :---- | :---- | :---- | :---- |
| FR-01 | System shall allow users to select the Authority (PUDA/GMADA/GLADA/BDA) and initiate the 'Certificate of Registration as Estate Agent' service. | Must | User can initiate the service for a selected authority; service landing page shows key requirements and SLS. |
...
| FR-12 | System shall support fee/payment capture for the service where applicable. Offline instrument: Demand Draft of Rs. 2500 \+ 18% GST in favour of Addl. Chief Administrator (GMADA) payable at Mohali; Bank Guarantee of Rs. 10,000 (as per service details). | Should | If fee is configured: payment is captured (online transaction or offline instrument details) and receipt/reference is stored; failures are handled gracefully. |
...
| BR-02 | Applicant must meet eligibility: educational qualification not less than Matric; age at least 18 years; PAN; experience certificate (as per checklist). | Must | System enforces required documents for eligibility and does not allow submission without them. |
| BR-03 | Demand draft of Rs. 2500 \+ 18% GST and bank guarantee of Rs. 10,000 shall be required as per service checklist (offline instruments). | Must | System captures DD/BG details and requires upload of supporting documents; application cannot be approved until verified (configurable). |
...
| :---- | :---- | :---- | :---- |
| Application Submitted | Applicant | SMS/Email/In-app | Acknowledgement with ARN for Certificate of Registration as Estate Agent. |
...
PUDA: Your 'Certificate of Registration as Estate Agent' application has been submitted. ARN: {ARN}. Track status on portal.

SMS \- Query Raised (Template)

PUDA: Query raised for ARN {ARN} in 'Certificate of Registration as Estate Agent'. Please respond by {DUE\_DATE} on portal.

SMS \- Application Approved (Template)

PUDA: Your 'Certificate of Registration as Estate Agent' application ARN {ARN} is approved. Download certificate/letter from portal.
...
| :---- | :---- | :---- | :---- | :---- | :---- |
| TC-EA-01 | Happy path approval without query | Applicant logged in; required data and documents available. | Fill form \-\> upload docs \-\> submit \-\> internal processing \-\> approve \-\> download output | Application is approved within SLS; output is generated and downloadable. | Happy |
| TC-EA-02 | Mandatory field validation | Applicant logged in. | Attempt submission with missing mandatory fields | System blocks submission and highlights missing fields. | Negative |
| TC-EA-03 | Mandatory document missing | Applicant logged in. | Attempt submission without uploading a mandatory document | System blocks submission and shows required document checklist. | Negative |
| TC-EA-04 | Query raised and resubmission | Application submitted successfully. | Officer raises query \-\> applicant receives notification \-\> applicant edits allowed fields/re-uploads docs \-\> resubmits | Application returns to the originating officer; query is marked resolved on further processing. | Rework |
| TC-EA-05 | Rejection by competent authority | Application submitted successfully. | Application processed \-\> approver rejects with reason code and remarks | Status becomes Rejected; rejection order is generated; applicant is notified. | Negative |
| TC-EA-06 | SLA breach at an internal stage | Application pending at a stage beyond due date. | Let task exceed configured due date | Task flagged overdue; escalation notification sent; breach recorded in report. | SLA |
| TC-EA-07 | Document mismatch detected during scrutiny | Application submitted. | Officer marks document mismatch and raises query or rejects | System captures mismatch reason; applicant is notified; workflow follows decision. | Negative |
| TC-EA-08 | Physical verification fail | Physical verification required for service. | Verifier records failed verification \-\> approver rejects (or raises query) | Decision recorded with verification remarks; applicant notified; output generated. | Negative |
| TC-EA-09 | No-fee service does not prompt for payment | Applicant initiates service. | Proceed to submission flow | No payment step is shown by default; submission succeeds based on data/docs. | Functional |
| TC-EA-10 | Duplicate application detection | An existing active application exists for same key identifiers. | Submit a second application with same identifiers | System warns or blocks duplicate submission as per configured rule. | Negative |
| TC-EA-11 | Role-based access control for internal staff | Two staff users with different roles. | Attempt to access applications outside role/jurisdiction | Access denied or masked data; attempt is logged. | Security |
| TC-EA-12 | Output download and verification | Application disposed. | Applicant downloads output; verify QR/digital signature (if enabled) | Output is readable and verifiable; download logged in audit. | Functional |
...
| :---- | :---- | :---- | :---- |
| 1 | Fill application form, upload documents and submit application | FR-01, FR-02, FR-03, FR-04, FR-05, DR-01, DR-02, DR-03 | TC-EA-01, TC-EA-02, TC-EA-03 |
| 2 | Validate mandatory fields and required documents | FR-06, FR-08, FR-14, FR-15, DR-01, DR-06, NFR-09 | TC-EA-01, TC-EA-12 |
| 3 | Initial scrutiny | FR-08, FR-09, FR-10, FR-13, BR-06, DR-06, DR-08, FR-11, BR-05 | TC-EA-04, TC-EA-05, TC-EA-06, TC-EA-08 |
| 4 | Provide clarifications/corrections | FR-01, FR-02, FR-03, FR-04, FR-05, DR-01, DR-02, DR-03 | TC-EA-01, TC-EA-02, TC-EA-03 |
| 5 | Verification and review | FR-08, FR-09, FR-10, FR-13, BR-06, DR-06, DR-08, FR-11, BR-05 | TC-EA-04, TC-EA-05, TC-EA-06, TC-EA-08 |
| 6 | Final review | FR-08, FR-09, FR-10, FR-13, BR-06, DR-06, DR-08, FR-11, BR-05 | TC-EA-04, TC-EA-05, TC-EA-06, TC-EA-08 |
| 7 | Generate certificate/letter (approval or rejection order), close application, and notify applicant | FR-06, FR-08, FR-14, FR-15, DR-01, DR-06, NFR-09 | TC-EA-01, TC-EA-12 |
| 8 | Download output and view final status | FR-01, FR-02, FR-03, FR-04, FR-05, DR-01, DR-02, DR-03 | TC-EA-01, TC-EA-02, TC-EA-03 |
...
* Workflow roles/levels and SLS are not shown on the service details page. Please confirm processing stages and timelines.  
...
* Is renewal handled via the same service using Form APR-XXII? If yes, what additional rules apply (e.g., validity, renewal fee)?  
...
* Service details page (input): https://www.puda.gov.in/service-details-estate-agent/28  
