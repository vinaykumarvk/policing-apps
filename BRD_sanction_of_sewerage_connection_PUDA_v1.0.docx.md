...
**Service: Sanction of Sewerage Connection**
...
Document Title: BRD \- Sanction of Sewerage Connection

Owning Department: Engineering / Public Health (PH) Branch (Assumption \- confirm with PUDA)

Primary Source of Truth: PUDA portal 'Sanction of Sewerage Connection' service details (https://www.puda.gov.in/service-details/30)
...
The 'Sanction of Sewerage Connection' service enables an applicant to submit an online request via the PUDA Citizen Services Portal/Mobile App. The system shall capture application details and required documents, route the request through role-based scrutiny/verification stages, enforce Service Level Standards (SLS), and on disposal generate a downloadable output (letter/certificate/order) along with notifications and audit trails.

Key service notes from input:

* Note :- No Fee applicable for issuance of Sewerage Connection.However ,if illegal sewer connection  found then penalty is levied.
...
| Attribute | Value |
| :---- | :---- |
| Service Name | Sanction of Sewerage Connection |
| Service Category | Water & Sewerage Services |
| Authorities | PUDA, GMADA, GLADA, BDA (as displayed on portal header) |
| Application Disposal Time (SLS) | 7 Days |
| Workflow Roles | Clerk (1 day) \-\> Junior Engineer (2 days) \-\> SDO (PH) (1 day) \-\> Disposal |
| Document(s) Required | Self attested copy of Occupation Certificate issued by the Estate Officer; Water Receipt Photocopy; Undertaking by the Applicant in the prescribed format; ... |
| Physical Verification | Required. Details to be confirmed. |
| Output | Sewerage Connection Letter / Approval (downloadable). |
...
* Request for sanction/approval of sewerage connection for a property under the selected authority.

Preconditions (to be validated):

* Property exists in authority records and is identifiable via UPN/Plot/Scheme.  
* Occupation Certificate and water receipt are available as per checklist.  
* Applicant provides undertaking and plumber certificate in prescribed format.
...
| 5 | Junior Engineer | Application package \+ previous stage remarks/verification records | Verification and review; record remarks; forward OR raise query OR reject (assumed) | Forwarded / Query raised / Rejected | Pending at SDO (PH) | 2 Days | If physical verification is required, completion may be mandatory prior to approval (Assumption). |
| 6 | SDO (PH) | Application package \+ previous stage remarks/verification records | Final review; confirm verification; approve or reject; record final remarks | Approved / Rejected | Approved OR Rejected | 1 Day | If physical verification is required, completion may be mandatory prior to approval (Assumption). |
...
| 3 | Building / Occupancy Details | Whether Building Is (status \- To be confirmed); Date of Sanction of Building Plan; Number of Floors Constructed; Is Basement Constructed; Number of Seats; Hot Water Fitting Material Details | Citizen-provided. Editable in Draft; locked after submit unless query. |
| 4 | Plumber / Installation Details | Hot Water Fitting Installation Bill Number; Name of the Plumber; License Number; Address of the Plumber; Date of Issue of Certificate | Citizen-provided. Editable in Draft; locked after submit unless query. |
| 5 | Documents & Submit | Upload mandatory documents as per Section 10; Applicant undertaking in prescribed format | Citizen uploads and submits. After submit, only resubmission possible via query. |
...
| DR-04 | System shall capture and store service-specific details (Building / Occupancy Details; Plumber / Installation Details) as structured data. | Must | Service-specific fields are stored and visible to processing officers; exports include these fields where relevant. |
...
| :---- | :---- | :---- | :---- | :---- | :---- |
| DOC-01 | Self attested copy of Occupation Certificate issued by the Estate Officer | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-02 | Water Receipt Photocopy | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-03 | Undertaking by the Applicant in the prescribed format | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |
| DOC-04 | Certificate from a plumber registered with the Authority in the prescribed form | Citizen/Applicant | Yes | Submission | Attested/self-attested as applicable; validation by processing officer. |

# **11\. Functional Requirements (FR)**

| ID | Description | Priority | Acceptance Criteria |
| :---- | :---- | :---- | :---- |
| FR-01 | System shall allow users to select the Authority (PUDA/GMADA/GLADA/BDA) and initiate the 'Sanction of Sewerage Connection' service. | Must | User can initiate the service for a selected authority; service landing page shows key requirements and SLS. |
...
| FR-11 | System shall support service-specific verification needs: No fee is applicable; penalty workflow (if illegal connection found) must be configurable. | Should | Verification outcome is captured as structured fields/remarks; approval can be configured to require verification completion. |
| FR-12 | System shall support fee/payment capture for the service where applicable. No fee applicable for issuance of Sewerage Connection (as per service note). Penalty may be levied if illegal sewer connection is found (penalty rules to be confirmed). | Should | If fee is configured: payment is captured (online transaction or offline instrument details) and receipt/reference is stored; failures are handled gracefully. |
...
| BR-02 | Occupation Certificate copy, Water receipt, Applicant undertaking and Plumber certificate shall be mandatory as per checklist. | Must | Submission is blocked if any mandatory document is missing. |
| BR-03 | No fee shall be charged for issuance of Sewerage Connection as per service note. | Must | System does not prompt for payment for this service by default configuration. |
| BR-04 | If illegal sewer connection is found during verification, penalty shall be levied as per authority rules (penalty rules to be confirmed). | Should | System supports capturing illegal-connection flag and penalty details; demand note/collection is generated if configured. |
...
| :---- | :---- | :---- | :---- |
| Application Submitted | Applicant | SMS/Email/In-app | Acknowledgement with ARN for Sanction of Sewerage Connection. |
...
PUDA: Your 'Sanction of Sewerage Connection' application has been submitted. ARN: {ARN}. Track status on portal.

SMS \- Query Raised (Template)

PUDA: Query raised for ARN {ARN} in 'Sanction of Sewerage Connection'. Please respond by {DUE\_DATE} on portal.

SMS \- Application Approved (Template)

PUDA: Your 'Sanction of Sewerage Connection' application ARN {ARN} is approved. Download certificate/letter from portal.
...
| :---- | :---- | :---- | :---- | :---- | :---- |
| TC-SC-01 | Happy path approval without query | Applicant logged in; required data and documents available. | Fill form \-\> upload docs \-\> submit \-\> internal processing \-\> approve \-\> download output | Application is approved within SLS; output is generated and downloadable. | Happy |
| TC-SC-02 | Mandatory field validation | Applicant logged in. | Attempt submission with missing mandatory fields | System blocks submission and highlights missing fields. | Negative |
| TC-SC-03 | Mandatory document missing | Applicant logged in. | Attempt submission without uploading a mandatory document | System blocks submission and shows required document checklist. | Negative |
| TC-SC-04 | Query raised and resubmission | Application submitted successfully. | Officer raises query \-\> applicant receives notification \-\> applicant edits allowed fields/re-uploads docs \-\> resubmits | Application returns to the originating officer; query is marked resolved on further processing. | Rework |
| TC-SC-05 | Rejection by competent authority | Application submitted successfully. | Application processed \-\> approver rejects with reason code and remarks | Status becomes Rejected; rejection order is generated; applicant is notified. | Negative |
| TC-SC-06 | SLA breach at an internal stage | Application pending at a stage beyond due date. | Let task exceed configured due date | Task flagged overdue; escalation notification sent; breach recorded in report. | SLA |
| TC-SC-07 | Document mismatch detected during scrutiny | Application submitted. | Officer marks document mismatch and raises query or rejects | System captures mismatch reason; applicant is notified; workflow follows decision. | Negative |
| TC-SC-08 | Physical verification fail | Physical verification required for service. | Verifier records failed verification \-\> approver rejects (or raises query) | Decision recorded with verification remarks; applicant notified; output generated. | Negative |
| TC-SC-09 | No-fee service does not prompt for payment | Applicant initiates service. | Proceed to submission flow | No payment step is shown by default; submission succeeds based on data/docs. | Functional |
| TC-SC-10 | Duplicate application detection | An existing active application exists for same key identifiers. | Submit a second application with same identifiers | System warns or blocks duplicate submission as per configured rule. | Negative |
| TC-SC-11 | Role-based access control for internal staff | Two staff users with different roles. | Attempt to access applications outside role/jurisdiction | Access denied or masked data; attempt is logged. | Security |
| TC-SC-12 | Output download and verification | Application disposed. | Applicant downloads output; verify QR/digital signature (if enabled) | Output is readable and verifiable; download logged in audit. | Functional |
...
| :---- | :---- | :---- | :---- |
| 1 | Fill application form, upload documents and submit application | FR-01, FR-02, FR-03, FR-04, FR-05, DR-01, DR-02, DR-03 | TC-SC-01, TC-SC-02, TC-SC-03 |
| 2 | Validate mandatory fields and required documents | FR-06, FR-08, FR-14, FR-15, DR-01, DR-06, NFR-09 | TC-SC-01, TC-SC-12 |
| 3 | Initial scrutiny | FR-08, FR-09, FR-10, FR-13, BR-06, DR-06, DR-08, FR-11, BR-05 | TC-SC-04, TC-SC-05, TC-SC-06, TC-SC-08 |
| 4 | Provide clarifications/corrections | FR-01, FR-02, FR-03, FR-04, FR-05, DR-01, DR-02, DR-03 | TC-SC-01, TC-SC-02, TC-SC-03 |
| 5 | Verification and review | FR-08, FR-09, FR-10, FR-13, BR-06, DR-06, DR-08, FR-11, BR-05 | TC-SC-04, TC-SC-05, TC-SC-06, TC-SC-08 |
| 6 | Final review | FR-08, FR-09, FR-10, FR-13, BR-06, DR-06, DR-08, FR-11, BR-05 | TC-SC-04, TC-SC-05, TC-SC-06, TC-SC-08 |
| 7 | Generate certificate/letter (approval or rejection order), close application, and notify applicant | FR-06, FR-08, FR-14, FR-15, DR-01, DR-06, NFR-09 | TC-SC-01, TC-SC-12 |
| 8 | Download output and view final status | FR-01, FR-02, FR-03, FR-04, FR-05, DR-01, DR-02, DR-03 | TC-SC-01, TC-SC-02, TC-SC-03 |
...
* What is the penalty amount and calculation logic if an illegal sewer connection is found?  
* Is physical verification mandatory for all cases or only when risk flags/complaints exist?  
* Does the system need to capture plumber certificate details as structured fields and validate license number against a registry?  
...
* Service details page (input): https://www.puda.gov.in/service-details/30  
