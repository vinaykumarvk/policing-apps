...
**Document Title:** BRD \- Copies of Documents

**Owning Department:** Estate/Property Branch (Assumption \- confirm with PUDA)

**Primary Source of Truth:** PUDA portal service details (https://www.puda.gov.in/service-details/24), accessed 03 Feb 2026\.

**Application Disposal Time (SLS):** 3 Days (as published on service details page).
...
The 'Copies of Documents' service enables an applicant to submit an online request via the PUDA citizen portal for certified copies of requested puda documents issued to applicant. The application is processed through a role-based workflow (Clerk (1 day) \-\> Senior Assistant (1 day) \-\> Superintendent (1 day) \-\> Disposal). The published Service Level Standard (SLS) is 3 days.
...
| Attribute | Value |
| :---- | :---- |
| Service Name | Copies of Documents |
...
| Application Disposal Time (SLS) | 3 Days |
| Workflow Roles | Clerk (1 day) \-\> Senior Assistant (1 day) \-\> Superintendent (1 day) \-\> Disposal |
| Document(s) Required | Self attested copy of FIR/ Report in Daily Dairy Register (DDR); Application form /Self Declaration |
| Physical Verification | Not indicated on service page |
| Output | Certified copies of requested PUDA documents issued to applicant. |
...
Applicant requests certified copies of property-related PUDA documents (e.g., due to loss), supported by FIR/DDR.
...
The published processing sequence is: Submit Application \-\> Clerk (1 day) \-\> Senior Assistant (1 day) \-\> Superintendent (1 day) \-\> Disposal.
...
| 3 | Clerk | Application package \+ remarks | Review application and documents; record remarks; forward to next role OR raise query OR reject | Forwarded / Query raised / Rejected | Pending at Senior Assistant OR Query Pending OR Rejected | 1 Day | Physical verification/original document checks may be mandatory before approval (confirm). |
...
| 5 | Senior Assistant | Application package \+ remarks | Review application and documents; record remarks; forward to next role OR raise query OR reject | Forwarded / Query raised / Rejected | Pending at Superintendent OR Query Pending OR Rejected | 1 Day | Physical verification/original document checks may be mandatory before approval (confirm). |
...
| 7 | Superintendent | Application package \+ remarks | Review application and documents; record remarks; approve/reject | Approved / Rejected | Approved OR Rejected | 1 Day | Physical verification/original document checks may be mandatory before approval (confirm). |
...
| 3 | Copy Request Details | Requested document type(s) (TBD); FIR/DDR details (number/date/police station \- TBD) | Citizen enters; validated for format; internal verifies. |
...
| :---- | :---- | :---- | :---- | :---- | :---- |
| DOC-01 | Self attested copy of FIR/ Report in Daily Dairy Register (DDR) | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-02 | Application form /Self Declaration | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
...
Published application disposal time (SLS): 3 Days (as per service details page).

| Stage/Role | Published Stage Time | Notes |
| :---- | :---- | :---- |
| Clerk | 1 Day | Stage actions: forward/query/reject/approve as applicable. |
| Senior Assistant | 1 Day | Stage actions: forward/query/reject/approve as applicable. |
| Superintendent | 1 Day | Stage actions: forward/query/reject/approve as applicable. |
...
PUDA Service Details Page: https://www.puda.gov.in/service-details/24 (captured in input PDF).
