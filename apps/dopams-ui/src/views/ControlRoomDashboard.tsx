            ...
            <table className="entity-table entity-table--compact">
              ...
              <tbody>
                {queue.map(q => {
                  ...
                  return (
                    <tr key={q.alert_id} className={`entity-table__clickable ${rowClass}`} onClick={() => onNavigate("alert-detail")} tabIndex={0} role="link" onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); onNavigate("alert-detail"); } }}>
