import type {
  EntityRef, EntityState, StorageAdapter, TransactionHandle, WfDefinition,
...
const ENTITY_TABLE_MAP: Record<string, { table: string; idCol: string; stateCol: string }> = {
  sm_alert: { table: "sm_alert", idCol: "alert_id", stateCol: "state_id" },
  sm_case: { table: "case_record", idCol: "case_id", stateCol: "state_id" },
  sm_evidence: { table: "evidence_item", idCol: "evidence_id", stateCol: "state_id" },
  sm_report: { table: "report_instance", idCol: "report_id", stateCol: "state_id" },
};

export class SmStorageAdapter implements StorageAdapter {
