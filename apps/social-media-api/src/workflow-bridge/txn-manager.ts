...
export interface TransactionManager {
  runInTransaction<T>(fn: (txn: TransactionHandle) => Promise<T>, existingTxn?: TransactionHandle): Promise<T>;
}

export class SmTransactionManager implements TransactionManager {
