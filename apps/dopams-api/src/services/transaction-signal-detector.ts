...
const PURCHASE_PATTERNS: Array<{ pattern: RegExp; description: string }> = [
  ...
  { pattern: /(?:\u0C0E\u0C15\u0C4D\u0C15\u0C21\u0C3E\s*\u0C26\u0C4A\u0C30\u0C41\u0C15\u0C41\u0C24\u0C41\u0C02\u0C26\u0C3F|ekkada\s*dorukutundi)/i, description: "Telugu: Where to find" },
  { pattern: /(?:\u0C0E\u0C35\u0C30\u0C3F\s*\u0C26\u0C17\u0C4D\u0C17\u0C30\u0C3E\s*\u0C09\u0C02\u0C26\u0C3F|evari\s*daggara\s*undi)/i, description: "Telugu: Who has it" },
];
