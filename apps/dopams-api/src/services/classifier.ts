...
const KEYWORD_CATEGORIES: Record<string, string[]> = {
  DRUG_TRAFFICKING: ["traffick", "smuggl", "supply", "distribut", "courier", "cartel", "syndicate"],
  DRUG_MANUFACTURING: ["manufactur", "lab", "precursor", "chemical", "synthe"],
  DRUG_POSSESSION: ["possess", "consum", "personal use", "addict"],
  NARCOTICS: ["narcotic", "cocaine", "heroin", "opium", "morphine", "fentanyl"],
  CANNABIS: ["cannabis", "ganja", "marijuana", "hashish", "charas", "bhang"],
  SYNTHETIC_DRUGS: ["meth", "amphetamine", "mdma", "ecstasy", "lsd", "ketamine"],
  PHARMACEUTICAL: ["pharma", "tablet", "capsule", "prescription", "tramadol", "codeine"],
  MONEY_LAUNDERING: ["laundering", "hawala", "proceeds", "benami", "shell company"],
  ORGANIZED_CRIME: ["gang", "organized", "network", "racket", "mafia", "don"],
};
