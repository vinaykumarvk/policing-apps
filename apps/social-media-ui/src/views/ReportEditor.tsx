...
export default function ReportEditor({ id, authHeaders, isOffline, onBack }: Props) {
  ...
  return (
    <div className="panel">
      ...
      {/* Tab bar */}
      <div role="tablist" style={{ display: "flex", gap: "var(--space-1)", borderBottom: "2px solid var(--color-border)", marginBottom: "var(--space-4)" }}>
        {tabs.map((t_) => (
          <button
            key={t_.key}
            role="tab"
        ...
        <Card>
          <div style={{ display: "grid", gap: "var(--space-4)" }}>
            <div className="form-field">
              <label className="form-field__label">{t("reports.summary")}</label>
              <textarea
                className="form-textarea"
                value={summary}
                onChange={(e) => setSummary(e.target.value)}
                onBlur={isDraft ? saveContent : undefined}
                rows={4}
                disabled={!isDraft}
              />
            </div>
            <div className="form-field">
              <label className="form-field__label">{t("reports.findings")}</label>
              <textarea
                className="form-textarea"
                value={findings}
            ...
            <div className="form-field">
              <label className="form-field__label">{t("reports.methodology")}</label>
              <textarea
                className="form-textarea"
                value={methodology}
            ...
            <div className="form-field">
              <label className="form-field__label">{t("reports.conclusion")}</label>
              <textarea
                className="form-textarea"
                value={conclusion}
            ...
            <div className="form-field">
              <label className="form-field__label">{t("reports.recommendations")}</label>
              <textarea
                className="form-textarea"
