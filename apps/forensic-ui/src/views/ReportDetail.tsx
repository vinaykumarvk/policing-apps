...
import { apiBaseUrl, Report } from "../types";
        ...
        { key: "details", label: t("detail.tab_details"), content: (
          <div className="detail-section">
            ...
            <div className="detail-grid">
              ...
              <div className="detail-field"><span className="detail-field__label">{t("reports.type")}</span><span className="detail-field__value">{report.report_type}</span></div>
              <div className="detail-field"><span className="detail-field__label">{t("reports.version")}</span><span className="detail-field__value">{report.version_number}</span></div>
