...
**Service: Issuance of Conveyance Deed for extended area**
...
**Document Title:** BRD \- Issuance of Conveyance Deed for extended area

**Owning Department:** Estate/Property Branch (Assumption \- confirm with PUDA)

**Primary Source of Truth:** PUDA portal service details (https://www.puda.gov.in/service-details/1760), accessed 03 Feb 2026\.
...
The 'Issuance of Conveyance Deed for extended area' service enables an applicant to submit an online request via the PUDA citizen portal for conveyance deed for extended area (issued/executed) and record update. The application is processed through a role-based workflow (Clerk (4 days) \-\> Senior Assistant (5 days) \-\> Assistant Estate Officer (3 days) \-\> Estate Officer (3 days) \-\> Issuance of CD for Extended Area (7 days) \-\> Disposal). The published Service Level Standard (SLS) is 15 days. The service details page indicates that physical verification is required.
...
| Attribute | Value |
| :---- | :---- |
| Service Name | Issuance of Conveyance Deed for extended area |
...
| Workflow Roles | Clerk (4 days) \-\> Senior Assistant (5 days) \-\> Assistant Estate Officer (3 days) \-\> Estate Officer (3 days) \-\> Issuance of CD for Extended Area (7 days) \-\> Disposal |
| Document(s) Required | Self attested copy of No Due Certificate (Not required if No Due Certificate Issued Online); Certified copy of GPA / Sub Attorney (if applicable); copies of CD including one on Stamp Paper. Stamp Duty would be as applicable on date of executio of CD. Please check with Sub Registrar SAS Nagar |
| Physical Verification | Required (as per portal note) |
| Output | Conveyance Deed for extended area (issued/executed) and record update. |
...
Applicant seeks issuance of conveyance deed for extended area for the allotted property, as per PUDA process.
...
* Assistant Estate Officer \- processes the application at assigned stage with role-specific permissions.  
* Estate Officer \- processes the application at assigned stage with role-specific permissions.  
* Issuance of CD for Extended Area \- processes the application at assigned stage with role-specific permissions.  
...
The published processing sequence is: Submit Application \-\> Clerk (4 days) \-\> Senior Assistant (5 days) \-\> Assistant Estate Officer (3 days) \-\> Estate Officer (3 days) \-\> Issuance of CD for Extended Area (7 days) \-\> Disposal.
...
| 5 | Senior Assistant | Application package \+ remarks | Review application and documents; record remarks; forward to next role OR raise query OR reject | Forwarded / Query raised / Rejected | Pending at Assistant Estate Officer OR Query Pending OR Rejected | 5 Days | Physical verification/original document checks may be mandatory before approval (confirm). |
...
| 7 | Assistant Estate Officer | Application package \+ remarks | Review application and documents; record remarks; forward to next role OR raise query OR reject | Forwarded / Query raised / Rejected | Pending at Estate Officer OR Query Pending OR Rejected | 3 Days | Physical verification/original document checks may be mandatory before approval (confirm). |
| 8 | Applicant (if query raised) | Query/deficiency memo from authority | Provide clarification; correct fields; re-upload document(s) if required; resubmit | Resubmitted application | Resubmitted to Assistant Estate Officer | TBD | Query response time window and SLA pause/reset rules \- Open Question. |
| 9 | Estate Officer | Application package \+ remarks | Review application and documents; record remarks; forward to next role OR raise query OR reject | Forwarded / Query raised / Rejected | Pending at Issuance of CD for Extended Area OR Query Pending OR Rejected | 3 Days | Physical verification/original document checks may be mandatory before approval (confirm). |
| 10 | Applicant (if query raised) | Query/deficiency memo from authority | Provide clarification; correct fields; re-upload document(s) if required; resubmit | Resubmitted application | Resubmitted to Estate Officer | TBD | Query response time window and SLA pause/reset rules \- Open Question. |
| 11 | Issuance of CD for Extended Area | Application package \+ remarks | Review application and documents; record remarks; approve/reject | Approved / Rejected | Approved OR Rejected | 7 Days | Physical verification/original document checks may be mandatory before approval (confirm). |
| 12 | System | Final decision | Generate digitally signed/approved output (order/permission/certificate as applicable); update records; close application; notify applicant | Output generated; application closed | Closed | Same day | Integration with property master, document signing and dispatch \- to be confirmed. |
| 13 | Applicant | Disposed application | Download/print output; view final status and history | Output downloaded | Closed | NA | If physical originals submission is required, it must be communicated to applicant (Open Question). |
...
| Pending at Assistant Estate Officer | Application under processing by Assistant Estate Officer. | Auto-assign/forward | Forward / Query / Reject | Forward to next role OR Query Pending OR Rejected |
| Pending at Estate Officer | Application under processing by Estate Officer. | Auto-assign/forward | Forward / Query / Reject | Forward to next role OR Query Pending OR Rejected |
| Pending at Issuance of CD for Extended Area | Application under processing by Issuance of CD for Extended Area. | Auto-assign/forward | Forward / Query / Reject / Approve | Approved OR Rejected |
...
| 3 | Conveyance Deed Details | No Due Certificate reference; GPA/Sub Attorney details (if applicable); Stamp paper/stamp duty details (TBD) | Citizen enters and uploads supporting documents. |
...
| :---- | :---- | :---- | :---- | :---- | :---- |
| DOC-01 | Self attested copy of No Due Certificate (Not required if No Due Certificate Issued Online) | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-02 | Certified copy of GPA / Sub Attorney (if applicable) | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-03 | copies of CD including one on Stamp Paper. Stamp Duty would be as applicable on date of executio of CD. Please check with Sub Registrar SAS Nagar | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
...
| BR-06 | For Conveyance Deed (extended area), No Due Certificate is not required if it was issued online, as per service details. | Should | System allows NDC reference lookup/verification and does not force upload when online NDC exists. |
...
Published application disposal time (SLS): 15 Days (as per service details page).
...
| Assistant Estate Officer | 3 Days | Stage actions: forward/query/reject/approve as applicable. |
| Estate Officer | 3 Days | Stage actions: forward/query/reject/approve as applicable. |
| Issuance of CD for Extended Area | 7 Days | Stage actions: forward/query/reject/approve as applicable. |
...
| Step 7 | Assistant Estate Officer \- Review application and documents; record... | FR-01; FR-03; DR-01; NFR-03 | TC-01; TC-02; TC-03 |
| Step 8 | Applicant (if query raised) \- Provide clarification; correct fields; r... | FR-01; FR-03; DR-01; NFR-03 | TC-01; TC-02; TC-03 |
| Step 12 | System \- Output generation/closure | FR-12; IR-05; NFR-09; REP-01 | TC-01; TC-12 |
...
PUDA Service Details Page: https://www.puda.gov.in/service-details/1760 (captured in input PDF).
