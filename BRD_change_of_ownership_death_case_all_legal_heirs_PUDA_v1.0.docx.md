...
**Service: Change of Ownership (Death Case \- All Legal Heirs)**
...
**Document Title:** BRD \- Change of Ownership (Death Case \- All Legal Heirs)

**Owning Department:** Estate/Property Branch (Assumption \- confirm with PUDA)

**Primary Source of Truth:** PUDA portal service details (https://www.puda.gov.in/service-details/1508), accessed 03 Feb 2026\.
...
The 'Change of Ownership (Death Case \- All Legal Heirs)' service enables an applicant to submit an online request via the PUDA citizen portal for ownership updated in puda records; approval/rejection order and updated ownership extract (if applicable). The application is processed through a role-based workflow (Clerk (4 days) \-\> Senior Assistant (4 days) \-\> Estate Officer (6 days) \-\> Disposal). The published Service Level Standard (SLS) is 30 days. The service details page indicates that physical verification is required.
...
| Attribute | Value |
| :---- | :---- |
| Service Name | Change of Ownership (Death Case \- All Legal Heirs) |
...
| Workflow Roles | Clerk (4 days) \-\> Senior Assistant (4 days) \-\> Estate Officer (6 days) \-\> Disposal |
| Document(s) Required | Death Certificate. Original Document to be submitted in Authority; Clearance of previous Mortgage/ Loan/Redemption deed; Legal Heir Certificate. Original to be submitted at Authority.(Issued by the SDM / Tehsildar OR an; ... |
...
The published processing sequence is: Submit Application \-\> Clerk (4 days) \-\> Senior Assistant (4 days) \-\> Estate Officer (6 days) \-\> Disposal.
...
| 5 | Senior Assistant | Application package \+ remarks | Review application and documents; record remarks; forward to next role OR raise query OR reject | Forwarded / Query raised / Rejected | Pending at Estate Officer OR Query Pending OR Rejected | 4 Days | Physical verification/original document checks may be mandatory before approval (confirm). |
...
| :---- | :---- | :---- | :---- | :---- | :---- |
| DOC-01 | Death Certificate. Original Document to be submitted in Authority | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-02 | Clearance of previous Mortgage/ Loan/Redemption deed | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-03 | Legal Heir Certificate. Original to be submitted at Authority.(Issued by the SDM / Tehsildar OR an | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-04 | affidavit from the Area Councilor / Sarpanch) | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-05 | Any Additional document required for transfer on the basis of succession certificate issued by court | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-06 | Attach Certified copy of the decree of the Court | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
| DOC-07 | Liability Affidavit from all legal Heirs | Applicant | Yes | Submission | File format/size to be configured; verify authenticity and legibility. |
...
PUDA Service Details Page: https://www.puda.gov.in/service-details/1508 (captured in input PDF).
